CREATE DATABASE  IF NOT EXISTS `inqueetesdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `inqueetesdb`;
...
CREATE TABLE `answer` (
  ...
  `answer_id_question_fk` varchar(15) NOT NULL,
...
CREATE TABLE `option` (
  ...
  `id_question_fk` varchar(15) NOT NULL,
...
INSERT INTO `option` VALUES (1,'Praia.','1'),(2,'Paris','1'),(3,'Bahaia','1'),(5,'EUA','AVS002'),(6,'BA','1');
...
CREATE TABLE `question` (
  `idquestion` varchar(15) NOT NULL,
...
INSERT INTO `question` VALUES ('1','Qual a viagem dos sonhos ?',1,1),('AVS002','O melhor lugar do mundo?',1,9),('AVS003','Quantos anos eu tenho?',1,1),('AVS004','Comida favorita',1,1);
...
-- Dump completed on 2020-11-10 11:06:44
